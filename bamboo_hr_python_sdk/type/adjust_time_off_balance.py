...
class RequiredAdjustTimeOffBalance(TypedDict):
...
class OptionalAdjustTimeOffBalance(TypedDict, total=False):
    # This is an optional note to show in history.
    note: str

class AdjustTimeOffBalance(RequiredAdjustTimeOffBalance, OptionalAdjustTimeOffBalance):
    pass
