...
class RequiredTimeTrackingPrivateBetaAddEditClockEntriesRequestEntriesItem(TypedDict):
...
class OptionalTimeTrackingPrivateBetaAddEditClockEntriesRequestEntriesItem(TypedDict, total=False):
...
class TimeTrackingPrivateBetaAddEditClockEntriesRequestEntriesItem(RequiredTimeTrackingPrivateBetaAddEditClockEntriesRequestEntriesItem, OptionalTimeTrackingPrivateBetaAddEditClockEntriesRequestEntriesItem):
    pass
