...
from bamboo_hr_python_sdk.exceptions_base import ApiValueError
from bamboo_hr_python_sdk.exceptions import ClientConfigurationError
from bamboo_hr_python_sdk.exceptions import InvalidHostConfigurationError
...
conf = bamboo_hr_python_sdk.Configuration(
    username='the-user',
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self.host = "https://api.bamboohr.com/api/gateway.php" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger = logging.getLogger("bamboo_hr_python_sdk")
...
class OAuth:
    def __init__(self, client_id: typing.AnyStr, client_secret: typing.AnyStr, token_url: str = "https://{companyDomain}.bamboohr.com/token.php") -> None:
