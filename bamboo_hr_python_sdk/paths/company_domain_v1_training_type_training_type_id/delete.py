...
class RemoveTypeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_type(
        self,
        company_domain: str,
        training_type_id: int,
        **kwargs,
        ...
        args = self._remove_type_mapped_args(
            company_domain=company_domain,
            training_type_id=training_type_id,
        )
        return await self._aremove_type_oapg(
    ...
    def remove_type(
        ...
        return self._remove_type_oapg(
            path_params=args.path,
        )

class RemoveType(BaseApi):
    ...
    async def aremove_type(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_type(
            company_domain=company_domain,
            training_type_id=training_type_id,
            **kwargs,
        )
    ...
    def remove_type(
        ...
        raw_response = self.raw.remove_type(
            company_domain=company_domain,
            training_type_id=training_type_id,
        )
