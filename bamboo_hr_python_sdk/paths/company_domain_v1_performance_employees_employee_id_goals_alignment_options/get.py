...
class BaseApi(api_client.Api):
    ...
    def _get_alignable_options_mapped_args(
        self,
        company_domain: str,
        employee_id: str,
    ...
    async def _aget_alignable_options_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/{companyDomain}/v1/performance/employees/{employeeId}/goals/alignmentOptions',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_alignable_options_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetAlignableOptionsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_alignable_options(
        self,
        company_domain: str,
        employee_id: str,
        body: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_alignable_options_mapped_args(
            body=body,
            company_domain=company_domain,
            employee_id=employee_id,
        )
        return await self._aget_alignable_options_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def get_alignable_options(
        self,
        company_domain: str,
        employee_id: str,
        body: typing.Optional[str] = None,
        ...
        return self._get_alignable_options_oapg(
            body=args.body,
            path_params=args.path,
        )

class GetAlignableOptions(BaseApi):
    ...
    async def aget_alignable_options(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_alignable_options(
            body=body,
            company_domain=company_domain,
            employee_id=employee_id,
            **kwargs,
    ...
    def get_alignable_options(
        ...
        raw_response = self.raw.get_alignable_options(
            body=body,
            company_domain=company_domain,
            employee_id=employee_id,
        )
