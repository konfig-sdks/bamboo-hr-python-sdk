    ...
    async def _aadd_row_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/{companyDomain}/v1_1/employees/{id}/tables/{table}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
...
class AddRowRaw(BaseApi):
    ...
    async def aadd_row(
        ...
        **kwargs,
        ...
        args = self._add_row_mapped_args(
        ...
        return await self._aadd_row_oapg(
            body=args.body,
    ...
    def add_row(
        ...
        return self._add_row_oapg(
            body=args.body,
            path_params=args.path,
        )

class AddRow(BaseApi):
    ...
    async def aadd_row(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aadd_row(
            company_domain=company_domain,
            id=id,
            table=table,
            date=date,
