...
from bamboo_hr_python_sdk.model.post_new_employee_file_category import PostNewEmployeeFileCategory as PostNewEmployeeFileCategorySchema

from bamboo_hr_python_sdk.type.post_new_employee_file_category import PostNewEmployeeFileCategory

from ...api_client import Dictionary
from bamboo_hr_python_sdk.pydantic.post_new_employee_file_category import PostNewEmployeeFileCategory as PostNewEmployeeFileCategoryPydantic
...
# body param
SchemaForRequestBodyApplicationJson = PostNewEmployeeFileCategorySchema


request_body_post_new_employee_file_category = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _add_category_mapped_args(
        self,
        body: PostNewEmployeeFileCategory,
        company_domain: str,
    ...
    async def _aadd_category_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/{companyDomain}/v1/employees/files/categories',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_post_new_employee_file_category.serialize(body, content_type)
