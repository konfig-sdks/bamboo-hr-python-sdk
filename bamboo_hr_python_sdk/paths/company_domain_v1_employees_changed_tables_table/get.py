...
class BaseApi(api_client.Api):
    ...
    def _get_changed_table_rows_mapped_args(
        self,
        company_domain: str,
        table: str,
        since: str,
    ...
    async def _aget_changed_table_rows_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/{companyDomain}/v1/employees/changed/tables/{table}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_changed_table_rows_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetChangedTableRowsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_changed_table_rows(
        self,
        company_domain: str,
        table: str,
        since: str,
        **kwargs,
        ...
        args = self._get_changed_table_rows_mapped_args(
            company_domain=company_domain,
            table=table,
            since=since,
        )
        return await self._aget_changed_table_rows_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_changed_table_rows(
        self,
        company_domain: str,
        table: str,
        since: str,
        ...
        return self._get_changed_table_rows_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetChangedTableRows(BaseApi):
    ...
    async def aget_changed_table_rows(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_changed_table_rows(
            company_domain=company_domain,
            table=table,
            since=since,
            **kwargs,
    ...
    def get_changed_table_rows(
        ...
        raw_response = self.raw.get_changed_table_rows(
            company_domain=company_domain,
            table=table,
            since=since,
        )
