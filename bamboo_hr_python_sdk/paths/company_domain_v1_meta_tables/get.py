...
class BaseApi(api_client.Api):
    ...
    def _discover_table_fields_mapped_args(
        self,
        company_domain: str,
    ...
    async def _adiscover_table_fields_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/{companyDomain}/v1/meta/tables',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _discover_table_fields_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DiscoverTableFieldsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adiscover_table_fields(
        self,
        company_domain: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._discover_table_fields_mapped_args(
            company_domain=company_domain,
        )
        return await self._adiscover_table_fields_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def discover_table_fields(
        self,
        company_domain: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._discover_table_fields_oapg(
            path_params=args.path,
        )

class DiscoverTableFields(BaseApi):
    ...
    async def adiscover_table_fields(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adiscover_table_fields(
            company_domain=company_domain,
            **kwargs,
        )
    ...
    def discover_table_fields(
        ...
        raw_response = self.raw.discover_table_fields(
            company_domain=company_domain,
        )
