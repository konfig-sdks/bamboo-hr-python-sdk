...
class BaseApi(api_client.Api):
    ...
    def _get_list_fields_mapped_args(
        self,
        company_domain: str,
    ...
    async def _aget_list_fields_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/{companyDomain}/v1/meta/lists',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetListFieldsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_list_fields(
        self,
        company_domain: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_list_fields_mapped_args(
            company_domain=company_domain,
        )
        return await self._aget_list_fields_oapg(
    ...
    def get_list_fields(
        ...
        return self._get_list_fields_oapg(
            path_params=args.path,
        )

class GetListFields(BaseApi):
    ...
    async def aget_list_fields(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_list_fields(
            company_domain=company_domain,
            **kwargs,
        )
    ...
    def get_list_fields(
        ...
        raw_response = self.raw.get_list_fields(
            company_domain=company_domain,
        )
