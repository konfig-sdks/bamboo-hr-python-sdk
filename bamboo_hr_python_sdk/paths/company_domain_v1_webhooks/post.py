...
from bamboo_hr_python_sdk.model.webhooks_add_new_webhook403_response import WebhooksAddNewWebhook403Response as WebhooksAddNewWebhook403ResponseSchema
...
from bamboo_hr_python_sdk.model.webhooks_add_new_webhook_response import WebhooksAddNewWebhookResponse as WebhooksAddNewWebhookResponseSchema
...
from bamboo_hr_python_sdk.type.webhooks_add_new_webhook403_response import WebhooksAddNewWebhook403Response
from bamboo_hr_python_sdk.type.new_web_hook_monitor_fields import NewWebHookMonitorFields
from bamboo_hr_python_sdk.type.webhooks_add_new_webhook_response import WebhooksAddNewWebhookResponse
...
from bamboo_hr_python_sdk.pydantic.webhooks_add_new_webhook_response import WebhooksAddNewWebhookResponse as WebhooksAddNewWebhookResponsePydantic
from bamboo_hr_python_sdk.pydantic.new_web_hook_limit import NewWebHookLimit as NewWebHookLimitPydantic
from bamboo_hr_python_sdk.pydantic.webhooks_add_new_webhook403_response import WebhooksAddNewWebhook403Response as WebhooksAddNewWebhook403ResponsePydantic
...
SchemaFor201ResponseBodyApplicationJson = WebhooksAddNewWebhookResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: WebhooksAddNewWebhookResponse
...
SchemaFor403ResponseBodyApplicationJson = WebhooksAddNewWebhook403ResponseSchema


@dataclass
class ApiResponseFor403(api_client.ApiResponse):
    body: WebhooksAddNewWebhook403Response
...
class BaseApi(api_client.Api):
    ...
    def _add_new_webhook_mapped_args(
        self,
        name: str,
    ...
    async def _aadd_new_webhook_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/{companyDomain}/v1/webhooks',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
...
class AddNewWebhookRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_new_webhook(
        self,
        name: str,
        monitor_fields: NewWebHookMonitorFields,
        post_fields: NewWebHookPostFields,
        ...
        **kwargs,
        ...
        args = self._add_new_webhook_mapped_args(
            name=name,
        ...
        return await self._aadd_new_webhook_oapg(
            body=args.body,
    ...
    def add_new_webhook(
        ...
        return self._add_new_webhook_oapg(
            body=args.body,
            path_params=args.path,
        )

class AddNewWebhook(BaseApi):
    ...
    async def aadd_new_webhook(
        ...
        validate: bool = False,
        **kwargs,
    ) -> WebhooksAddNewWebhookResponsePydantic:
        raw_response = await self.raw.aadd_new_webhook(
            name=name,
            monitor_fields=monitor_fields,
            post_fields=post_fields,
            url=url,
        ...
        if validate:
            return WebhooksAddNewWebhookResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(WebhooksAddNewWebhookResponsePydantic, raw_response.body)
    ...
    def add_new_webhook(
        ...
        raw_response = self.raw.add_new_webhook(
            name=name,
            monitor_fields=monitor_fields,
            post_fields=post_fields,
            url=url,
