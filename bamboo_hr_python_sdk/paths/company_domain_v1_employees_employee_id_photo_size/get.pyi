...
request_path_size = api_client.PathParameter(
    name="size",
    style=api_client.ParameterStyle.SIMPLE,
    schema=SizeSchema,
    required=True,
...
class BaseApi(api_client.Api):
    ...
    def _get_employee_photo_mapped_args(
        self,
        company_domain: str,
        employee_id: str,
        size: str,
    ...
    async def _aget_employee_photo_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/{companyDomain}/v1/employees/{employeeId}/photo/{size}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetEmployeePhotoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_employee_photo(
        self,
        company_domain: str,
        employee_id: str,
        size: str,
        **kwargs,
        ...
        args = self._get_employee_photo_mapped_args(
            company_domain=company_domain,
            employee_id=employee_id,
            size=size,
        )
        return await self._aget_employee_photo_oapg(
    ...
    def get_employee_photo(
        ...
        return self._get_employee_photo_oapg(
            path_params=args.path,
        )

class GetEmployeePhoto(BaseApi):
    ...
    async def aget_employee_photo(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_employee_photo(
            company_domain=company_domain,
            employee_id=employee_id,
            size=size,
            **kwargs,
    ...
    def get_employee_photo(
        ...
        raw_response = self.raw.get_employee_photo(
            company_domain=company_domain,
            employee_id=employee_id,
            size=size,
        )
