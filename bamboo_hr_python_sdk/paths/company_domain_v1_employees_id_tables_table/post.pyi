...
class BaseApi(api_client.Api):
    ...
    def _add_table_row_mapped_args(
        self,
        company_domain: str,
        id: str,
        table: str,
    ...
    async def _aadd_table_row_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/{companyDomain}/v1/employees/{id}/tables/{table}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
...
class AddTableRowRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_table_row(
        self,
        company_domain: str,
        id: str,
        table: str,
        ...
        **kwargs,
        ...
        args = self._add_table_row_mapped_args(
        ...
        return await self._aadd_table_row_oapg(
            body=args.body,
    ...
    def add_table_row(
        ...
        return self._add_table_row_oapg(
            body=args.body,
            path_params=args.path,
        )

class AddTableRow(BaseApi):
    ...
    async def aadd_table_row(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aadd_table_row(
            company_domain=company_domain,
            id=id,
            table=table,
            date=date,
    ...
    def add_table_row(
        ...
        raw_response = self.raw.add_table_row(
            company_domain=company_domain,
            id=id,
            table=table,
            date=date,
