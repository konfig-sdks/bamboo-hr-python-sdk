...
class BaseApi(api_client.Api):
    ...
    def _get_changed_employee_ids_mapped_args(
        self,
        company_domain: str,
        since: str,
    ...
    async def _aget_changed_employee_ids_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/{companyDomain}/v1/employees/changed',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_changed_employee_ids_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetChangedEmployeeIdsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_changed_employee_ids(
        self,
        company_domain: str,
        since: str,
        type: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_changed_employee_ids_mapped_args(
            company_domain=company_domain,
            since=since,
            type=type,
        )
        return await self._aget_changed_employee_ids_oapg(
    ...
    def get_changed_employee_ids(
        ...
        return self._get_changed_employee_ids_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetChangedEmployeeIds(BaseApi):
    ...
    async def aget_changed_employee_ids(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_changed_employee_ids(
            company_domain=company_domain,
            since=since,
            type=type,
            **kwargs,
    ...
    def get_changed_employee_ids(
        ...
        raw_response = self.raw.get_changed_employee_ids(
            company_domain=company_domain,
            since=since,
            type=type,
        )
