...
class BaseApi(api_client.Api):
    ...
    def _get_project_tasks_mapped_args(
        self,
        company_domain: str,
        employee_id: str,
        project_id: str,
    ...
    async def _aget_project_tasks_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/{companyDomain}/v1/time_tracking/employee/{employeeId}/projects/{projectId}/tasks',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetProjectTasksRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_project_tasks(
        self,
        company_domain: str,
        employee_id: str,
        project_id: str,
        **kwargs,
        ...
        args = self._get_project_tasks_mapped_args(
            company_domain=company_domain,
            employee_id=employee_id,
            project_id=project_id,
        )
        return await self._aget_project_tasks_oapg(
    ...
    def get_project_tasks(
        ...
        return self._get_project_tasks_oapg(
            path_params=args.path,
        )

class GetProjectTasks(BaseApi):
    ...
    async def aget_project_tasks(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_project_tasks(
            company_domain=company_domain,
            employee_id=employee_id,
            project_id=project_id,
            **kwargs,
    ...
    def get_project_tasks(
        ...
        raw_response = self.raw.get_project_tasks(
            company_domain=company_domain,
            employee_id=employee_id,
            project_id=project_id,
        )
