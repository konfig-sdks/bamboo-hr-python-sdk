...
class BaseApi(api_client.Api):
    ...
    def _get_benefit_groups_mapped_args(
        self,
        company_domain: str,
    ...
    async def _aget_benefit_groups_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/{companyDomain}/v1/benefitgroups',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetBenefitGroupsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_benefit_groups(
        self,
        company_domain: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_benefit_groups_mapped_args(
            company_domain=company_domain,
        )
        return await self._aget_benefit_groups_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_benefit_groups(
        self,
        company_domain: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._get_benefit_groups_oapg(
            path_params=args.path,
        )

class GetBenefitGroups(BaseApi):
    ...
    async def aget_benefit_groups(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_benefit_groups(
            company_domain=company_domain,
            **kwargs,
        )
    ...
    def get_benefit_groups(
        ...
        raw_response = self.raw.get_benefit_groups(
            company_domain=company_domain,
        )
