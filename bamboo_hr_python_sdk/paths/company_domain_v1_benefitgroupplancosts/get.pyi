...
class BaseApi(api_client.Api):
    ...
    def _get_group_plan_costs_mapped_args(
        self,
        company_domain: str,
    ...
    async def _aget_group_plan_costs_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/{companyDomain}/v1/benefitgroupplancosts',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_group_plan_costs_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetGroupPlanCostsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_group_plan_costs(
        self,
        company_domain: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_group_plan_costs_mapped_args(
            company_domain=company_domain,
        )
        return await self._aget_group_plan_costs_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_group_plan_costs(
        self,
        company_domain: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._get_group_plan_costs_oapg(
            path_params=args.path,
        )

class GetGroupPlanCosts(BaseApi):
    ...
    async def aget_group_plan_costs(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_group_plan_costs(
            company_domain=company_domain,
            **kwargs,
        )
    ...
    def get_group_plan_costs(
        ...
        raw_response = self.raw.get_group_plan_costs(
            company_domain=company_domain,
        )
