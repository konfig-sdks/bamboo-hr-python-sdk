...
class BaseApi(api_client.Api):
    ...
    def _get_time_off_requests_mapped_args(
        self,
        company_domain: str,
        start: str,
        end: str,
    ...
    async def _aget_time_off_requests_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/{companyDomain}/v1/time_off/requests',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_time_off_requests_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetTimeOffRequestsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_time_off_requests(
        self,
        company_domain: str,
        start: str,
        end: str,
        ...
        **kwargs,
        ...
        args = self._get_time_off_requests_mapped_args(
        ...
        return await self._aget_time_off_requests_oapg(
    ...
    def get_time_off_requests(
        ...
        return self._get_time_off_requests_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetTimeOffRequests(BaseApi):
    ...
    async def aget_time_off_requests(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_time_off_requests(
            company_domain=company_domain,
            start=start,
            end=end,
            id=id,
    ...
    def get_time_off_requests(
        ...
        raw_response = self.raw.get_time_off_requests(
            company_domain=company_domain,
            start=start,
            end=end,
            id=id,
