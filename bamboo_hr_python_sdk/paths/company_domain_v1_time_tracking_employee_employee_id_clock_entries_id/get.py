...
class BaseApi(api_client.Api):
    ...
    def _get_clock_entry_mapped_args(
        self,
        company_domain: str,
        employee_id: str,
        id: str,
    ...
    async def _aget_clock_entry_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/{companyDomain}/v1/time_tracking/employee/{employeeId}/clock_entries/{id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetClockEntryRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_clock_entry(
        self,
        company_domain: str,
        employee_id: str,
        id: str,
        **kwargs,
        ...
        args = self._get_clock_entry_mapped_args(
            company_domain=company_domain,
            employee_id=employee_id,
            id=id,
        )
        return await self._aget_clock_entry_oapg(
    ...
    def get_clock_entry(
        ...
        return self._get_clock_entry_oapg(
            path_params=args.path,
        )

class GetClockEntry(BaseApi):
    ...
    async def aget_clock_entry(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_clock_entry(
            company_domain=company_domain,
            employee_id=employee_id,
            id=id,
            **kwargs,
    ...
    def get_clock_entry(
        ...
        raw_response = self.raw.get_clock_entry(
            company_domain=company_domain,
            employee_id=employee_id,
            id=id,
        )
