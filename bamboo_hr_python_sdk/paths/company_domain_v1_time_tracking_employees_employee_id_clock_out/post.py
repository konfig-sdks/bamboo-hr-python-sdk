...
class BaseApi(api_client.Api):
    ...
    def _add_clock_out_mapped_args(
        self,
        company_domain: str,
        employee_id: str,
    ...
    async def _aadd_clock_out_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/{companyDomain}/v1/time_tracking/employees/{employeeId}/clock_out',
            auth_settings=_auth,
            headers=_headers,
        )
...
class AddClockOutRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_clock_out(
        self,
        company_domain: str,
        employee_id: str,
        **kwargs,
        ...
        args = self._add_clock_out_mapped_args(
            company_domain=company_domain,
            employee_id=employee_id,
        )
        return await self._aadd_clock_out_oapg(
    ...
    def add_clock_out(
        ...
        return self._add_clock_out_oapg(
            path_params=args.path,
        )

class AddClockOut(BaseApi):
    ...
    async def aadd_clock_out(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aadd_clock_out(
            company_domain=company_domain,
            employee_id=employee_id,
            **kwargs,
        )
    ...
    def add_clock_out(
        ...
        raw_response = self.raw.add_clock_out(
            company_domain=company_domain,
            employee_id=employee_id,
        )
        if validate:
