...
from bamboo_hr_python_sdk.model.company_file_update import CompanyFileUpdate as CompanyFileUpdateSchema

from bamboo_hr_python_sdk.type.company_file_update import CompanyFileUpdate

from ...api_client import Dictionary
from bamboo_hr_python_sdk.pydantic.company_file_update import CompanyFileUpdate as CompanyFileUpdatePydantic
...
# body param
SchemaForRequestBodyApplicationJson = CompanyFileUpdateSchema


request_body_company_file_update = api_client.RequestBody(
    content={
    ...
    async def _aupdate_file_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/{companyDomain}/v1/files/{fileId}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_company_file_update.serialize(body, content_type)
