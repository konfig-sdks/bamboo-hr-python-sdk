...
class BaseApi(api_client.Api):
    ...
    def _delete_hour_record_mapped_args(
        self,
        company_domain: str,
        id: str,
    ...
    async def _adelete_hour_record_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/{companyDomain}/v1/timetracking/delete/{id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class DeleteHourRecordRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_hour_record(
        self,
        company_domain: str,
        id: str,
        **kwargs,
        ...
        args = self._delete_hour_record_mapped_args(
            company_domain=company_domain,
            id=id,
        )
        return await self._adelete_hour_record_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def delete_hour_record(
        self,
        company_domain: str,
        id: str,
    ) -> typing.Union[
        ...
        return self._delete_hour_record_oapg(
            path_params=args.path,
        )

class DeleteHourRecord(BaseApi):
    ...
    async def adelete_hour_record(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_hour_record(
            company_domain=company_domain,
            id=id,
            **kwargs,
        )
    ...
    def delete_hour_record(
        ...
        raw_response = self.raw.delete_hour_record(
            company_domain=company_domain,
            id=id,
        )
