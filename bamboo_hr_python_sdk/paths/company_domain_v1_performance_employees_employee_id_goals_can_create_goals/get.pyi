...
class BaseApi(api_client.Api):
    ...
    def _determine_permission_mapped_args(
        self,
        company_domain: str,
        employee_id: str,
    ...
    async def _adetermine_permission_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/{companyDomain}/v1/performance/employees/{employeeId}/goals/canCreateGoals',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _determine_permission_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DeterminePermissionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adetermine_permission(
        self,
        company_domain: str,
        employee_id: str,
        **kwargs,
        ...
        args = self._determine_permission_mapped_args(
            company_domain=company_domain,
            employee_id=employee_id,
        )
        return await self._adetermine_permission_oapg(
    ...
    def determine_permission(
        ...
        return self._determine_permission_oapg(
            path_params=args.path,
        )

class DeterminePermission(BaseApi):
    ...
    async def adetermine_permission(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adetermine_permission(
            company_domain=company_domain,
            employee_id=employee_id,
            **kwargs,
        )
    ...
    def determine_permission(
        ...
        raw_response = self.raw.determine_permission(
            company_domain=company_domain,
            employee_id=employee_id,
        )
