...
class BaseApi(api_client.Api):
    ...
    def _get_field_list_mapped_args(
        self,
        company_domain: str,
    ...
    async def _aget_field_list_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/{companyDomain}/v1/meta/fields',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetFieldListRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_field_list(
        self,
        company_domain: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_field_list_mapped_args(
            company_domain=company_domain,
        )
        return await self._aget_field_list_oapg(
    ...
    def get_field_list(
        ...
        return self._get_field_list_oapg(
            path_params=args.path,
        )

class GetFieldList(BaseApi):
    ...
    async def aget_field_list(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_field_list(
            company_domain=company_domain,
            **kwargs,
        )
    ...
    def get_field_list(
        ...
        raw_response = self.raw.get_field_list(
            company_domain=company_domain,
        )
