...
from bamboo_hr_python_sdk.model.goals_update_progress_response import GoalsUpdateProgressResponse as GoalsUpdateProgressResponseSchema

from bamboo_hr_python_sdk.type.goals_update_progress_response import GoalsUpdateProgressResponse

from ...api_client import Dictionary
from bamboo_hr_python_sdk.pydantic.goals_update_progress_response import GoalsUpdateProgressResponse as GoalsUpdateProgressResponsePydantic
...
GoalIdSchema = schemas.IntSchema
...
SchemaFor200ResponseBodyApplicationJson = GoalsUpdateProgressResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: GoalsUpdateProgressResponse
    ...
    async def _aupdate_progress_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/{companyDomain}/v1/performance/employees/{employeeId}/goals/{goalId}/progress',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
...
class UpdateProgress(BaseApi):
    ...
    async def aupdate_progress(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GoalsUpdateProgressResponsePydantic:
        ...
        if validate:
            return GoalsUpdateProgressResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GoalsUpdateProgressResponsePydantic, raw_response.body)
