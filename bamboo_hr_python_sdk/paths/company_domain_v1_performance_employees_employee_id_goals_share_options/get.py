...
class BaseApi(api_client.Api):
    ...
    def _share_options_get_mapped_args(
        self,
        company_domain: str,
        employee_id: str,
    ...
    async def _ashare_options_get_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/{companyDomain}/v1/performance/employees/{employeeId}/goals/shareOptions',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ShareOptionsGetRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ashare_options_get(
        self,
        company_domain: str,
        employee_id: str,
        search: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._share_options_get_mapped_args(
            company_domain=company_domain,
            employee_id=employee_id,
            search=search,
            limit=limit,
        )
        return await self._ashare_options_get_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def share_options_get(
        self,
        company_domain: str,
        employee_id: str,
        search: typing.Optional[str] = None,
        ...
        return self._share_options_get_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ShareOptionsGet(BaseApi):
    ...
    async def ashare_options_get(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.ashare_options_get(
            company_domain=company_domain,
            employee_id=employee_id,
            search=search,
            limit=limit,
    ...
    def share_options_get(
        ...
        raw_response = self.raw.share_options_get(
            company_domain=company_domain,
            employee_id=employee_id,
            search=search,
            limit=limit,
