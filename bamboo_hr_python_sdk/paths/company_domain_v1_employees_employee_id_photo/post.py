...
class BaseApi(api_client.Api):
    ...
    def _store_new_employee_photo_mapped_args(
        self,
        company_domain: str,
        employee_id: str,
    ...
    async def _astore_new_employee_photo_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/{companyDomain}/v1/employees/{employeeId}/photo',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _store_new_employee_photo_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class StoreNewEmployeePhotoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def astore_new_employee_photo(
        self,
        company_domain: str,
        employee_id: str,
        **kwargs,
        ...
        args = self._store_new_employee_photo_mapped_args(
            company_domain=company_domain,
            employee_id=employee_id,
        )
        return await self._astore_new_employee_photo_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def store_new_employee_photo(
        self,
        company_domain: str,
        employee_id: str,
    ) -> typing.Union[
        ...
        return self._store_new_employee_photo_oapg(
            path_params=args.path,
        )

class StoreNewEmployeePhoto(BaseApi):
    ...
    async def astore_new_employee_photo(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.astore_new_employee_photo(
            company_domain=company_domain,
            employee_id=employee_id,
            **kwargs,
        )
    ...
    def store_new_employee_photo(
        ...
        raw_response = self.raw.store_new_employee_photo(
            company_domain=company_domain,
            employee_id=employee_id,
        )
