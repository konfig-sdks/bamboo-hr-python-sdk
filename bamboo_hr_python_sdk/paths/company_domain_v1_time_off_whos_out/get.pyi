...
class BaseApi(api_client.Api):
    ...
    def _get_whos_out_list_mapped_args(
        self,
        company_domain: str,
    ...
    async def _aget_whos_out_list_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/{companyDomain}/v1/time_off/whos_out',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetWhosOutListRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_whos_out_list(
        self,
        company_domain: str,
        start: typing.Optional[str] = None,
        end: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_whos_out_list_mapped_args(
            company_domain=company_domain,
            start=start,
            end=end,
        )
        return await self._aget_whos_out_list_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_whos_out_list(
        self,
        company_domain: str,
        start: typing.Optional[str] = None,
        end: typing.Optional[str] = None,
        ...
        return self._get_whos_out_list_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetWhosOutList(BaseApi):
    ...
    async def aget_whos_out_list(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_whos_out_list(
            company_domain=company_domain,
            start=start,
            end=end,
            **kwargs,
    ...
    def get_whos_out_list(
        ...
        raw_response = self.raw.get_whos_out_list(
            company_domain=company_domain,
            start=start,
            end=end,
        )
