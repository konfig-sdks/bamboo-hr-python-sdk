...
class BaseApi(api_client.Api):
    ...
    def _get_group_plans_mapped_args(
        self,
        company_domain: str,
    ...
    async def _aget_group_plans_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/{companyDomain}/v1/benefitgroupplans',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetGroupPlansRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_group_plans(
        self,
        company_domain: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_group_plans_mapped_args(
            company_domain=company_domain,
        )
        return await self._aget_group_plans_oapg(
    ...
    def get_group_plans(
        ...
        return self._get_group_plans_oapg(
            path_params=args.path,
        )

class GetGroupPlans(BaseApi):
    ...
    async def aget_group_plans(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_group_plans(
            company_domain=company_domain,
            **kwargs,
        )
    ...
    def get_group_plans(
        ...
        raw_response = self.raw.get_group_plans(
            company_domain=company_domain,
        )
