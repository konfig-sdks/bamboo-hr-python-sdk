...
class BaseApi(api_client.Api):
    ...
    def _get_unpaid_paystubs_mapped_args(
        self,
        company_domain: str,
        id: str,
    ...
    async def _aget_unpaid_paystubs_oapg(
        self,
...
class GetUnpaidPaystubsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_unpaid_paystubs(
        self,
        company_domain: str,
        id: str,
        **kwargs,
        ...
        args = self._get_unpaid_paystubs_mapped_args(
            company_domain=company_domain,
            id=id,
        )
        return await self._aget_unpaid_paystubs_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_unpaid_paystubs(
        self,
        company_domain: str,
        id: str,
    ) -> typing.Union[
        ...
        return self._get_unpaid_paystubs_oapg(
            path_params=args.path,
        )

class GetUnpaidPaystubs(BaseApi):
    ...
    async def aget_unpaid_paystubs(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_unpaid_paystubs(
            company_domain=company_domain,
            id=id,
            **kwargs,
        )
    ...
    def get_unpaid_paystubs(
        ...
        raw_response = self.raw.get_unpaid_paystubs(
            company_domain=company_domain,
            id=id,
        )
