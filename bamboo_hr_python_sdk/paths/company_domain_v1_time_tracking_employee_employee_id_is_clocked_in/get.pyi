...
class BaseApi(api_client.Api):
    ...
    def _employee_clocked_in_mapped_args(
        self,
        company_domain: str,
        employee_id: str,
    ...
    async def _aemployee_clocked_in_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/{companyDomain}/v1/time_tracking/employee/{employeeId}/is_clocked_in',
            auth_settings=_auth,
            headers=_headers,
        )
...
class EmployeeClockedInRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aemployee_clocked_in(
        self,
        company_domain: str,
        employee_id: str,
        **kwargs,
        ...
        args = self._employee_clocked_in_mapped_args(
            company_domain=company_domain,
            employee_id=employee_id,
        )
        return await self._aemployee_clocked_in_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def employee_clocked_in(
        self,
        company_domain: str,
        employee_id: str,
    ) -> typing.Union[
        ...
        return self._employee_clocked_in_oapg(
            path_params=args.path,
        )

class EmployeeClockedIn(BaseApi):
    ...
    async def aemployee_clocked_in(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aemployee_clocked_in(
            company_domain=company_domain,
            employee_id=employee_id,
            **kwargs,
        )
    ...
    def employee_clocked_in(
        ...
        raw_response = self.raw.employee_clocked_in(
            company_domain=company_domain,
            employee_id=employee_id,
        )
