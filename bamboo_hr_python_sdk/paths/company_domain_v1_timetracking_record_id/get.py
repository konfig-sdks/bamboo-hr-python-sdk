...
class BaseApi(api_client.Api):
    ...
    def _get_hour_record_mapped_args(
        self,
        company_domain: str,
        id: str,
    ...
    async def _aget_hour_record_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/{companyDomain}/v1/timetracking/record/{id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetHourRecordRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_hour_record(
        self,
        company_domain: str,
        id: str,
        **kwargs,
        ...
        args = self._get_hour_record_mapped_args(
            company_domain=company_domain,
            id=id,
        )
        return await self._aget_hour_record_oapg(
    ...
    def get_hour_record(
        ...
        return self._get_hour_record_oapg(
            path_params=args.path,
        )

class GetHourRecord(BaseApi):
    ...
    async def aget_hour_record(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_hour_record(
            company_domain=company_domain,
            id=id,
            **kwargs,
        )
    ...
    def get_hour_record(
        ...
        raw_response = self.raw.get_hour_record(
            company_domain=company_domain,
            id=id,
        )
