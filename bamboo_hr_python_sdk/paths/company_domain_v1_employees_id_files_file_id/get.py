...
class BaseApi(api_client.Api):
    ...
    def _get_employee_file_mapped_args(
        self,
        company_domain: str,
        id: str,
        file_id: str,
    ...
    async def _aget_employee_file_oapg(
        self,
...
class GetEmployeeFileRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_employee_file(
        self,
        company_domain: str,
        id: str,
        file_id: str,
        **kwargs,
        ...
        args = self._get_employee_file_mapped_args(
            company_domain=company_domain,
            id=id,
            file_id=file_id,
        )
        return await self._aget_employee_file_oapg(
    ...
    def get_employee_file(
        ...
        return self._get_employee_file_oapg(
            path_params=args.path,
        )

class GetEmployeeFile(BaseApi):
    ...
    async def aget_employee_file(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_employee_file(
            company_domain=company_domain,
            id=id,
            file_id=file_id,
            **kwargs,
    ...
    def get_employee_file(
        ...
        raw_response = self.raw.get_employee_file(
            company_domain=company_domain,
            id=id,
            file_id=file_id,
        )
