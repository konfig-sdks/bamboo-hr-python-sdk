...
class BaseApi(api_client.Api):
    ...
    def _get_coverages_mapped_args(
        self,
        company_domain: str,
    ...
    async def _aget_coverages_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/{companyDomain}/v1/benefitcoverages',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetCoveragesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_coverages(
        self,
        company_domain: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_coverages_mapped_args(
            company_domain=company_domain,
        )
        return await self._aget_coverages_oapg(
    ...
    def get_coverages(
        ...
        return self._get_coverages_oapg(
            path_params=args.path,
        )

class GetCoverages(BaseApi):
    ...
    async def aget_coverages(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_coverages(
            company_domain=company_domain,
            **kwargs,
        )
    ...
    def get_coverages(
        ...
        raw_response = self.raw.get_coverages(
            company_domain=company_domain,
        )
