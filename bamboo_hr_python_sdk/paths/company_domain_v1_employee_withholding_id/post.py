...
from bamboo_hr_python_sdk.model.employee_withholding import EmployeeWithholding as EmployeeWithholdingSchema

from bamboo_hr_python_sdk.type.employee_withholding import EmployeeWithholding

from ...api_client import Dictionary
from bamboo_hr_python_sdk.pydantic.employee_withholding import EmployeeWithholding as EmployeeWithholdingPydantic
...
# body param
SchemaForRequestBodyApplicationJson = EmployeeWithholdingSchema


request_body_employee_withholding = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _add_employee_withholdings_mapped_args(
        self,
        company_domain: str,
        id: str,
        fed_withholding: typing.Optional[str] = None,
        ...
        _path_params = {}
        _body = {}
        if fed_withholding is not None:
            _body["fedWithholding"] = fed_withholding
    ...
    async def _aadd_employee_withholdings_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/{companyDomain}/v1/employee_withholding/{id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_employee_withholding.serialize(body, content_type)
    ...
    def _add_employee_withholdings_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class AddEmployeeWithholdingsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_employee_withholdings(
        self,
        company_domain: str,
        id: str,
        fed_withholding: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._add_employee_withholdings_mapped_args(
        ...
        return await self._aadd_employee_withholdings_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def add_employee_withholdings(
        self,
        company_domain: str,
        id: str,
        fed_withholding: typing.Optional[str] = None,
        ...
        return self._add_employee_withholdings_oapg(
            body=args.body,
            path_params=args.path,
        )

class AddEmployeeWithholdings(BaseApi):
    ...
    async def aadd_employee_withholdings(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aadd_employee_withholdings(
            company_domain=company_domain,
            id=id,
            fed_withholding=fed_withholding,
            state_withholding=state_withholding,
    ...
    def add_employee_withholdings(
        ...
        raw_response = self.raw.add_employee_withholdings(
            company_domain=company_domain,
            id=id,
            fed_withholding=fed_withholding,
            state_withholding=state_withholding,
