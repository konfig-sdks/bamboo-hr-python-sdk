...
class State(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "abbrev", "iso_code", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "name", "abbrev", "iso_code", ], str]):
