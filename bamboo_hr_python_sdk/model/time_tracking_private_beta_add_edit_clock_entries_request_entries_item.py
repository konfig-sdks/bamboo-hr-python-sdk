...
class TimeTrackingPrivateBetaAddEditClockEntriesRequestEntriesItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["employeeId", "date", "start", "end", "id", "projectId", "taskId", "note", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["employeeId", "date", "start", "end", "id", "projectId", "taskId", "note", ], str]):
    ...
    ) -> 'TimeTrackingPrivateBetaAddEditClockEntriesRequestEntriesItem':
