...
class TimeTrackingEditClockedInEntryDataRequestClockOutLocation(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["latitude", "longitude", "accuracy", "address", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["latitude", "longitude", "accuracy", "address", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        accuracy: typing.Union[MetaOapg.properties.accuracy, decimal.Decimal, int, schemas.Unset] = schemas.unset,
