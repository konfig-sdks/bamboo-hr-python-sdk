...
class ApplicantTrackingCreateNewApplicationResponseItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            candidateId = schemas.NumberSchema
            __annotations__ = {
                "result": result,
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["result", "candidateId", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["result", "candidateId", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        candidateId: typing.Union[MetaOapg.properties.candidateId, decimal.Decimal, int, float, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'ApplicantTrackingCreateNewApplicationResponseItem':
