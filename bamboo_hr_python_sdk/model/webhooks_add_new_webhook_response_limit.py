...
class WebhooksAddNewWebhookResponseLimit(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["times", "seconds", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["times", "seconds", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        times: typing.Union[MetaOapg.properties.times, decimal.Decimal, int, schemas.Unset] = schemas.unset,
