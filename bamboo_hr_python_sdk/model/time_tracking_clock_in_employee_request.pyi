...
class TimeTrackingClockInEmployeeRequest(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def clockInLocation() -> typing.Type['TimeTrackingClockInEmployeeRequestClockInLocation']:
                return TimeTrackingClockInEmployeeRequestClockInLocation
            __annotations__ = {
                "start": start,
                "timezone": timezone,
                "note": note,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["clockInLocation"]) -> 'TimeTrackingClockInEmployeeRequestClockInLocation': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["start", "timezone", "note", "projectId", "taskId", "clockInLocation", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["clockInLocation"]) -> typing.Union['TimeTrackingClockInEmployeeRequestClockInLocation', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["start", "timezone", "note", "projectId", "taskId", "clockInLocation", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        clockInLocation: typing.Union['TimeTrackingClockInEmployeeRequestClockInLocation', schemas.Unset] = schemas.unset,
