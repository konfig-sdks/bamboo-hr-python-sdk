...
class WebhooksListMonitorFieldsResponseFieldsItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "alias", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "name", "alias", ], str]):
    ...
    ) -> 'WebhooksListMonitorFieldsResponseFieldsItem':
