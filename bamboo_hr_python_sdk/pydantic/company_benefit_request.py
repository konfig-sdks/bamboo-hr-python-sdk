...
class CompanyBenefitRequest(BaseModel):
    # Description
    ...
    # Is a safe harbor
    safe_harbor: typing.Optional[bool] = Field(None, alias='safeHarbor')

    # Meets ACA minimum requirements
    meet_aca_min: typing.Optional[bool] = Field(None, alias='meetAcaMin')
    ...
    reimbursement_currency_code: typing.Optional[str] = Field(None, alias='reimbursementCurrencyCode')

    # Provides minimum essential coverage
    min_essential_coverage: typing.Optional[bool] = Field(None, alias='minEssentialCoverage')
