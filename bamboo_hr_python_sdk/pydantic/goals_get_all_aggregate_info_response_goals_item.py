...
from bamboo_hr_python_sdk.pydantic.goals_get_all_aggregate_info_response_goals_item_shared_with_employee_ids import GoalsGetAllAggregateInfoResponseGoalsItemSharedWithEmployeeIds

class GoalsGetAllAggregateInfoResponseGoalsItem(BaseModel):
    # Title of the goal.
    ...
    shared_with_employee_ids: typing.Optional[GoalsGetAllAggregateInfoResponseGoalsItemSharedWithEmployeeIds] = Field(None, alias='sharedWithEmployeeIds')
