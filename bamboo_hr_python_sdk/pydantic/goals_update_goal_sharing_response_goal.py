...
from bamboo_hr_python_sdk.pydantic.goals_update_goal_sharing_response_goal_shared_with_employee_ids import GoalsUpdateGoalSharingResponseGoalSharedWithEmployeeIds

class GoalsUpdateGoalSharingResponseGoal(BaseModel):
    # Title of the goal.
    ...
    shared_with_employee_ids: typing.Optional[GoalsUpdateGoalSharingResponseGoalSharedWithEmployeeIds] = Field(None, alias='sharedWithEmployeeIds')
